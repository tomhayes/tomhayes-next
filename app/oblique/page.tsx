    ...
    <Section>
      <Container className="space-y-6">
        <Prose className="mb-8">
          <h2>Oblique</h2>
          <p>This is a simple AI-based tool to generate creative prompts similar to Brian Eno&apos;s <a href="https://en.wikipedia.org/wiki/Oblique_Strategies">Oblique Strategies</a>,
          ...
          <p>This is purely an experiment for myself in using AI - if you find this useful, please go and buy a set of cards!</p>
        </Prose>
